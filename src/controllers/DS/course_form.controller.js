...
exports.updateCourseForm = async (req, res) => {
    try {
        const { id } = req.params;
        const { name, status, email, duration,price,phone, course_interested, previous_lessons, transmission, postcode, additional_message } = req.body;
        
        const formData = {
            name, email, status, phone,duration,price, course_interested, previous_lessons, transmission, postcode, additional_message
        };
